...
if '--clean' in sys.argv:
  ...
  os.system('mv ./configurations/unbound.conf /etc/unbound/unbound.conf.d/pi-hole.conf')
  os.system('sudo service unbound restart')
  os.system('mv ./configurations/edns.conf /etc/dnsmasq.d/99-edns.conf')
  ...
  if sys.argv[sys.argv.index('--config')+1]=='main':
    os.system('mv ./configurations/keepalived-main.conf /etc/keepalived/keepalived.conf')
  elif sys.argv[sys.argv.index('--config')+1]=='backup':
    os.system('mv ./configurations/keepalived-backup.conf /etc/keepalived/keepalived.conf')
  ...
  os.system('mv ./configurations/custom.conf /etc/dnsmasq.d/98-custom.conf')
